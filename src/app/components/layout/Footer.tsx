        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[['/', 'Accueil'], ['/projets', 'Projets'], ['/a-propos', 'À propos'], ['/cv', 'CV'], ['/contact', 'Contact']].map(([href, label]) => (
                <li key={href}>
                  <a href={href} className="text-[#6B6B70] hover:text-[#F97316] transition-colors">{label}</a>
                </li>
              ))}
            </ul>
          </div>
