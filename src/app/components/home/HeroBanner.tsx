        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light mb-4 leading-tight">
              Arthur{' '}
              <span className="font-semibold" style={{ background: 'linear-gradient(135deg, #F97316, #E85D73, #EC4899)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                Eletti
              </span>
            </h1>
            <p className="text-xl font-medium mb-3" style={{ background: 'linear-gradient(135deg, #F97316, #EC4899)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
              Étudiant BUT Science des Données
            </p>
            <p className="text-base text-muted-foreground mb-8 max-w-xl leading-relaxed">{profile.bio}</p>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.2 }}
            ...
            <div className="relative">
              <div className="absolute -inset-4 rounded-full blur-2xl opacity-30" style={{ background: 'linear-gradient(135deg, #F97316, #EC4899)' }} />
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full p-1" style={{ background: 'linear-gradient(135deg, #F97316, #E85D73, #EC4899)' }}>
                <img src={profile.avatarUrl} alt="Arthur Eletti" className="w-full h-full rounded-full object-cover border-4 border-background" />
              </div>
            </div>
          </motion.div>
        </div>
