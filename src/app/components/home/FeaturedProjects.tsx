...
export function FeaturedProjects() {
  // GreenSD toujours en premier, puis 2 placeholders pour les futurs projets
  ...
  const placeholders = [
    {
      ...
      tags: [], featured: true, status: 'draft' as const, publishedAt: '',
      body: '', githubUrl: undefined, pdfUrl: undefined, colabUrl: undefined,
    },
    {
      id: 'ph2', slug: '#', title: 'Projet à venir',
      summary: 'Description disponible prochainement.',
      ...
      <div className="max-w-[1200px] mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <p className="text-muted-foreground mb-12">
            Une sélection de mes projets les plus représentatifs
          </p>
